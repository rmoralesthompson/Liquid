/*
 * Idiomorph — DOM morphing library, vendored for Liquid (#106, ADR-0005).
 * Upstream: https://github.com/bigskysoftware/idiomorph (dist/idiomorph.min.js)
 * License: Zero-Clause BSD (0BSD) — no attribution required; included as courtesy.
 *
 * Permission to use, copy, modify, and/or distribute this software for any
 * purpose with or without fee is hereby granted. THE SOFTWARE IS PROVIDED "AS
 * IS" AND THE AUTHOR DISCLAIMS ALL WARRANTIES WITH REGARD TO THIS SOFTWARE.
 *
 * Vendored verbatim (not modified). Exposes the global `Idiomorph` with
 * `Idiomorph.morph(node, newContent, config)`, used by runtime.js applyPatch.
 */
